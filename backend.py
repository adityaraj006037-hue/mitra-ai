...
Uses direct HTTP to Groq API — no groq library, no version conflicts.
"""

from fastapi import FastAPI, UploadFile, File, HTTPException, Form, Body
from fastapi.middleware.cors import CORSMiddleware
import os, uuid, time, io, httpx
...
# =============================================================================
# GROQ VIA DIRECT HTTP — no library needed
# =============================================================================
async def call_groq(system: str, messages: list, max_tokens: int = 1500):
...
async def chat_with_space(
    ...
    system_prompts = {
        ...
        "summary": "You are MITRA. Give a structured summary with Key Topics, Main Arguments, Important Facts, Conclusions.\nDocuments: " + doc_names + "\n\nCONTEXT:\n" + context,
        "quiz": "You are MITRA. Generate 5 quiz questions with answers.\nDocuments: " + doc_names + "\n\nCONTEXT:\n" + context,
        "explain": "You are MITRA. Explain key concepts simply with analogies.\nDocuments: " + doc_names + "\n\nCONTEXT:\n" + context,
        "mindmap": "You are MITRA. Create a structured mind map outline using tree format.\nDocuments: " + doc_names + "\n\nCONTEXT:\n" + context,
    }
